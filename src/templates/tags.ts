...
export function tagsIndexPage(tags: TagInfo[], pages: Page[], cssHref: string): Raw {
...
export function tagPage(tag: TagInfo, slice: PageSlice<Page>, cssHref: string): Raw {
  const body = html`
