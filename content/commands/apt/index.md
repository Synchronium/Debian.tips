...
[apt vs apt-get](/compare/apt-vs-apt-get/) covers where they do differ.
...
Every state-changing apt command prints its plan and waits for confirmation. Read the plan
rather than skipping to the y/n. It tells you what is about to be **installed**, **upgraded**,
**removed** and, the line worth reading twice, what is **no longer required**.
...
habit of running those unprivileged. The examples below mark which is which.
