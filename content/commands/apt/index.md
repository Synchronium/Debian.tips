...
fail to find a package that is right there in the archive, or offer you a version that was superseded weeks
...
answered about a root password when you set the machine up. Anything that only
